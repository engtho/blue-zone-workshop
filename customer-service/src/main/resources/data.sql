INSERT INTO customers (id, name, email, phone, priority, region)
VALUES ('c-42', 'Ada Lovelace', 'ada@example.com', '+47 123 45 678', 2, 'Oslo'),
...
INSERT INTO customer_services (customer_id, service)
VALUES ('c-42', 'BROADBAND'),
       ('c-42', 'TV'),
       ('c-7', 'MOBILE'),
       ('c-7', 'BROADBAND'),
       ('c-100', 'BROADBAND'),
